        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative scroll-reveal" data-animation="slideInLeft">
            <div className="rounded-2xl overflow-hidden shadow-2xl scroll-reveal" data-animation="paperReveal">
              <img src="/images/JPG/sri-pavansai.png" alt="SRI Pavan Sai Hospital & Sai Pharmacy" className="w-full h-auto object-cover scroll-reveal" data-animation="paperReveal" />
            </div>
          </div>
