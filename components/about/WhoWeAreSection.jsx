        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative scroll-reveal" data-animation="slideInLeft">
            <div className="rounded-2xl overflow-hidden shadow-2xl scroll-reveal" data-animation="paperReveal">
              <img src="/images/JPG/pavan-sai-hospital.png" alt="Pavan Sai Hospital" className="w-full h-auto object-cover scroll-reveal" data-animation="paperReveal" />
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="type-body text-[var(--color-primary)]/70 scroll-reveal" data-animation="fadeInUp" data-delay="600">
              <span className="scroll-reveal" data-animation="fadeInUp">
                Our in-house pharmacy ensures that all prescribed medicines are readily available, making the entire treatment process seamless and convenient for our patients and their families.
              </span>
            </p>
