export const servicesData = [
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "What is the recovery time for a knee replacement?", answer: "Most patients can begin walking with support within a day of surgery. Full recovery and returning to normal activities typically takes 6 to 12 weeks with structured physical therapy.", open: false },
      { question: "Do you treat sports injuries like ACL tears?", answer: "Yes, we perform arthroscopic ACL reconstruction and meniscus repairs to restore joint stability and function for active individuals.", open: false }
    ]
  },
  {
  ...
  },
  {
    ...
    health_plan_items: [
      ...
      "TPA Desk Assistance",
      "FHPL & Mediassist Accepted",
      "Vidal (Steel Plant) Panel",
